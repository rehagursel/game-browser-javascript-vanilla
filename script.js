let games = [
  {
    id: 1,
    game: "Call of Duty",
    genre: ["shooters", "action", "battle royale"],
    state: "maintenance",
  },
  {
    id: 2,
    game: "Football Manager",
    genre: ["strategy", "sports", "moba"],
    state: "patching",
  },
  {
    id: 3,
    game: "Lorem ipsum dolor sit",
    genre: ["rpg", "kids", "demo"],
    state: "maintenance",
  },
  {
    id: 4,
    game: "Consectetur lorem adipiscing",
    genre: ["open world", "adventure", "platformer"],
    state: "available",
  },
  {
    id: 5,
    game: "Adipiscing consectetur dolor",
    genre: ["casual", "kids", "simulation"],
    state: "available",
  },
  {
    id: 6,
    game: "Adipiscing world edition",
  ...
  },
  {
    id: 7,
    game: "Age of Empires",
    genre: ["strategy", "action", "battle royale", "simulation"],
    state: "available",
  },
  {
    id: 8,
    game: "Total War",
    genre: ["strategy", "battle royale", "simulation"],
    state: "available",
  },
  {
    id: 9,
    game: "Warhammer",
    genre: ["strategy", "battle royale", "simulation", "horror"],
    state: "available",
  },
  {
    id: 10,
  ...
  { id: 20, game: "Fifa 2027", genre: ["sports"], state: "maintenance" },
  {
    id: 21,
    game: "Fighters arena",
    genre: ["sports", "horror", "simulation"],
    state: "available",
  },
  {
    id: 22,
...
for (let genreInput of genreInputs) {
  genreInput.addEventListener("change", () => {
    genresArr = Array.from(genreInputs)
      .filter((i) => i.checked)
      .map((i) => i.value);
...
for (let stateInput of stateInputs) {
  stateInput.addEventListener("change", () => {
    statesArr = Array.from(stateInputs)
      .filter((i) => i.checked)
      .map((i) => i.value);
